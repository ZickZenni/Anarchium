...
import com.zickzenni.anarchium.util.function.Float2Consumer;
...
public class GTA2Effect extends TimedEffect
{
    ...
    public static final EffectProperties<GTA2Effect> PROPERTIES = EffectProperties.Builder.of(GTA2Effect.class)
            .id("gta2")
